...
* The Rapidly API is designed to be as simple as possible. The **ProcessFile** example (see the
* **Examples** folder in the [Rapidly API repository on GitHub](<public-sdk-repo-url>))
...
* subfolder in the [Rapidly API repository on GitHub](<public-sdk-repo-url>).
